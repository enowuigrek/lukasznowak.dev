...
export const metadata = {
  ...
  keywords: ['aplikacja głosowa', 'notatki głosowe', 'PWA', 'organizacja myśli', 'React', 'AI', 'Łukasz Nowak'],
  ...
  twitter: {
    ...
    title: 'Peria — Aplikacja do organizacji myśli głosem',
    description: 'Mówisz jedno zdanie — Peria rozbija je na listę, notatkę i wydarzenie.',
  },
};
